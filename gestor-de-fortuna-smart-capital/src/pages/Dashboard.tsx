...
function Dashboard() {
  ...
  const maxExpenseByCategory = Math.max(
    ...Object.values(expensesByCategory).map(
  ...
  return (
    <div className="flex min-h-screen bg-[#121212] text-white">
      ...
      <div className="flex-1">
        ...
        <main className="p-8">
          <div className="mb-8 rounded-3xl border border-[#E0B04B]/20 bg-[#1a1a1a] p-6">
          ...
          {usedCurrencies.length === 0 ? (
            <div className="rounded-3xl border border-white/10 bg-[#1a1a1a] p-10 text-center">
